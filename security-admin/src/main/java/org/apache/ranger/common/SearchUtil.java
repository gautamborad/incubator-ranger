...
public class SearchUtil {
	...
	public SearchUtil() {
//		minInListLength = PropertiesUtil.getIntProperty("xa.db.min_inlist", minInListLength);
//		defaultDateFormat = PropertiesUtil.getProperty("xa.ui.defaultDateformat", defaultDateFormat);
